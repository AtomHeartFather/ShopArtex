...
{block name='page_content_container'}
  <section id="content" class="page-content page-my-account">
   ...
   <div class="account-menu row justify-content-center no-gutters">
       <div class="col col-sm-8 col-md-7 col-lg-6 col-xl-5">   

    <p class="account-menu-title">{l s='Welcome to your account. Here you can manage all of your personal information and orders.' d='Shop.Theme.Customeraccount'}</p>
    <hr>
