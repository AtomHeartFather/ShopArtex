...
function init(modelpath) {
    ...
    mat.map = new THREE.ImageUtils.loadTexture("themes/artex/assets/img/gray+.png");//путь к картинке
...
// mymodelloader(modelpath);
                            ...
                            renderer.setClearColor(0xaaaaaa, 0.5);//цвет фона, прозрачность от 0 до 1
